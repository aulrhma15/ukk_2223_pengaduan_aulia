            ...
            <div class="row">
                ...
                <div class="p-5">
                  <div class="text-center">
                    <h1 style="font-family: 'verdana' " class="h4 text-gray-900 mb-4">Silakan Masukan Biodata Untuk Mendaftar Aplikasi Pengaduan
                    Masyarakat</h1>
                  </div>
                  <form method="post" action="proses-register.php" class="user">
                    <div class="form-group">
                      <input name ="nik" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukan NIK Anda" required minlength="16" maxlength="16">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <input name ="confirmPassword" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Konfirmasi Password" required>
                    </div>
                    <div class="form-group">
                      <input name ="telp" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukan Nomer Telepon Anda" required>
                    </div>
                    ...
                    <a href="login.php" class="btn btn-success btn-user btn-block body-buttonlogin">
                      <i class="fa fa-laptop fa-fw"></i> Sudah Punya Akun? Silakan Login
                    </a>
                  </form>
                </div>
              </div>
